...
<html lang="en">
    ...
    <body class="bg-primary">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input  id="inputFirstName" type="text"  class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Enter name" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputEmailAddress" type="email" aria-describedby="emailHelp" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Enter email address" />
        ...
        <script src="/sbadmin/dist/js/jquery-3.4.1.min.js" crossorigin="anonymous"></script>
        <script src="/sbadmin/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
